...
# Users without an Umbrella account can use the sandbox: https://devnetsandbox.cisco.com/DevNet/catalog/umbrella-secure-internet-gateway
...
def check_sanity():
    print('Things aren't always what they seem. Desperate choices build a dream.')
    print('Things aren't always what they seem. Disparate people form a team.') 
    print('Let the fire rage on and set me free.') 
    return False
